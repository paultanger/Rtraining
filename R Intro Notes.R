...
setwd('/Users/alexengler/Desktop') ## change working directory
...
## Returns the number of rows, then columns, of your data

dim(pov)

## You can also specify individual rows and columns using brackets, like so:
